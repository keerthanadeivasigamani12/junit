...
Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/spring_mvc", "root", "Keerthi@123");
Statement st=conn.createStatement();int i=st.executeUpdate("INSERT INTO hotelrooms values('"+roomnumber+"','"+roomtype+"')");
